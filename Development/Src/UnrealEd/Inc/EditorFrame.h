...
private:
	...
	*/
	...
	void MenuFileSaveAsRetail( wxCommandEvent& In );
	void UI_MenuFileSaveAsRetail( wxUpdateUIEvent& In );
	...
	void MenuSyncCornerMarkers( wxCommandEvent &In );
	...
	void MenuCheckpoints( wxCommandEvent& In );
	void MenuGameState( wxCommandEvent& In );
	...
	void MenuMultiMoveToGrid( wxCommandEvent& In );
	void MenuMultiMoveToGrid2D( wxCommandEvent& In );
	void MenuFixRoundingErrors( wxCommandEvent& In );
	...
	void MenuAlignToLastSelected( wxCommandEvent& In );
